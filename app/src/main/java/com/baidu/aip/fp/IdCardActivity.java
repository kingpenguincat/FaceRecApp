...
public class IdCardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void jumpToOnlineVerify() {
        ...
        // 调转到活体识别界面
        Intent faceIntent = new Intent(IdCardActivity.this, CompareActivity.class);
        ...
        OCR.getInstance().recognizeIDCard(param, new OnResultListener<IDCardResult>() {
            ...
            public void onResult(IDCardResult result) {
                if (result != null) {
                    ...
                    Word addressWord = result.getAddress();
                    Word birthdayWord = result.getBirthday();
                    ...
                    if (addressWord != null) {
                        address = addressWord.getWords();
                    }
                    if(birthdayWord !=null){

                        birthday = birthdayWord.getWords();
                    }
                    jumpToOnlineVerify();
