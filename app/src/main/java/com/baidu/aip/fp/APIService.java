...
public class APIService {
    ...
    private static final String FACE_DETECT = "https://aip.baidubce.com/rest/2.0/face/v3/detect";
     ...
     * 人脸检测
     */
    public void faceDetect(OnResultListener listener,File file){
        DynamicParams params = new DynamicParams();
        ...
        params.setImgType("BASE64");
        params.setBase64Img(base64Img);
        params.putParam("face_type","CERT");

        RegResultParser parser = new RegResultParser();

        HttpUtil.getInstance().post(urlAppendCommonParams(FACE_DETECT), "image", params, parser,listener);
